...
extern dmac_instance_ctrl_t g_transfer_ctrl;
extern const transfer_cfg_t g_transfer_cfg;

#ifndef dmac_callback
...
#else
    #define g_spi0_P_TRANSFER_RX (&g_transfer0)
#endif
#undef RA_NOT_DEFINED
/** Timer on GPT Instance. */
extern const timer_instance_t g_timer0_125us;

/** Access the GPT instance using these structures when calling API functions directly (::p_api is not used). */
extern gpt_instance_ctrl_t g_timer0_125us_ctrl;
extern const timer_cfg_t g_timer0_125us_cfg;

#ifndef Timer0_125us_callback
